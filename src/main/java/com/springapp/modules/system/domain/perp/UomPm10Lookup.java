...
@Entity(name="uom_pm10_lookup")
public class UomPm10Lookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomPm10Lookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomPm10Lookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomPm10Lookup)) {
            return false;
        }
        UomPm10Lookup that = (UomPm10Lookup) other;
    ...
    /**
     * Compares this instance with another UomPm10Lookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomPm10Lookup)) return false;
        return this.equalKeys(other) && ((UomPm10Lookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomPm10Lookup |");
