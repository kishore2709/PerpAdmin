...
@Entity(name="uom_nox_lookup")
public class UomNoxLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomNoxLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomNoxLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomNoxLookup)) {
            return false;
        }
        UomNoxLookup that = (UomNoxLookup) other;
    ...
    /**
     * Compares this instance with another UomNoxLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomNoxLookup)) return false;
        return this.equalKeys(other) && ((UomNoxLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomNoxLookup |");
