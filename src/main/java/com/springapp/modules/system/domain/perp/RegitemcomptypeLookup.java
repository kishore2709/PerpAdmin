...
@Entity(name="regitemcomptype_lookup")
public class RegitemcomptypeLookup implements Serializable {
    ...
    @JoinColumn(name="RegItemCompType_UID", nullable=false)
    ...
    /**
     * Compares the key for this instance with another RegitemcomptypeLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class RegitemcomptypeLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof RegitemcomptypeLookup)) {
            return false;
        }
        RegitemcomptypeLookup that = (RegitemcomptypeLookup) other;
    ...
    /**
     * Compares this instance with another RegitemcomptypeLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegitemcomptypeLookup)) return false;
        return this.equalKeys(other) && ((RegitemcomptypeLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[RegitemcomptypeLookup |");
