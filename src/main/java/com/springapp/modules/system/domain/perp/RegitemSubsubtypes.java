...
@Entity(name="regitem_subsubtypes")
public class RegitemSubsubtypes implements Serializable {
    ...
    @OneToMany(mappedBy="regitemSubsubtypes")
    ...
    /**
     * Compares the key for this instance with another RegitemSubsubtypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class RegitemSubsubtypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof RegitemSubsubtypes)) {
            return false;
        }
        RegitemSubsubtypes that = (RegitemSubsubtypes) other;
    ...
    /**
     * Compares this instance with another RegitemSubsubtypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegitemSubsubtypes)) return false;
        return this.equalKeys(other) && ((RegitemSubsubtypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[RegitemSubsubtypes |");
