...
public class EngineType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another EngineType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class EngineType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof EngineType)) {
            return false;
        }
        EngineType that = (EngineType) other;
    ...
    /**
     * Compares this instance with another EngineType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EngineType)) return false;
        return this.equalKeys(other) && ((EngineType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[EngineType |");
