...
@Entity(name="fuel_additive_types")
public class FuelAdditiveTypes implements Serializable {
    ...
    /**
     * Compares the key for this instance with another FuelAdditiveTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class FuelAdditiveTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof FuelAdditiveTypes)) {
            return false;
        }
        FuelAdditiveTypes that = (FuelAdditiveTypes) other;
    ...
    /**
     * Compares this instance with another FuelAdditiveTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof FuelAdditiveTypes)) return false;
        return this.equalKeys(other) && ((FuelAdditiveTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[FuelAdditiveTypes |");
