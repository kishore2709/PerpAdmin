...
public class UserType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UserType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UserType and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another UserType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UserType)) return false;
        return this.equalKeys(other) && ((UserType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UserType |");
