...
public class LicenseTypes implements Serializable {
    ...
    @OneToMany(mappedBy="licenseTypes")
    ...
    /**
     * Compares the key for this instance with another LicenseTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class LicenseTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof LicenseTypes)) {
            return false;
        }
        LicenseTypes that = (LicenseTypes) other;
    ...
    /**
     * Compares this instance with another LicenseTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LicenseTypes)) return false;
        return this.equalKeys(other) && ((LicenseTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[LicenseTypes |");
