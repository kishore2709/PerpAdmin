...
@Entity(name="complaint_priority_type")
public class ComplaintPriorityType implements Serializable {
    ...
    @OneToMany(mappedBy="complaintPriorityType")
    private Set<NoteComplaints> noteComplaints;

    /** Default constructor. */
    public ComplaintPriorityType() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another ComplaintPriorityType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ComplaintPriorityType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ComplaintPriorityType)) {
            return false;
        }
        ComplaintPriorityType that = (ComplaintPriorityType) other;
    ...
    /**
     * Compares this instance with another ComplaintPriorityType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ComplaintPriorityType)) return false;
        return this.equalKeys(other) && ((ComplaintPriorityType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ComplaintPriorityType |");
