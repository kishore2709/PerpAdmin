...
@Entity(name="stw_types")
public class StwTypes implements Serializable {
    ...
    /**
     * Compares the key for this instance with another StwTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class StwTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof StwTypes)) {
            return false;
        }
        StwTypes that = (StwTypes) other;
    ...
    /**
     * Compares this instance with another StwTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof StwTypes)) return false;
        return this.equalKeys(other) && ((StwTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[StwTypes |");
