...
@Entity(name="ledger_action_types")
public class LedgerActionTypes implements Serializable {
    ...
    @OneToMany(mappedBy="ledgerActionTypes")
    private Set<Ledger> ledger;

    /** Default constructor. */
    public LedgerActionTypes() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another LedgerActionTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class LedgerActionTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof LedgerActionTypes)) {
            return false;
        }
        LedgerActionTypes that = (LedgerActionTypes) other;
    ...
    /**
     * Compares this instance with another LedgerActionTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LedgerActionTypes)) return false;
        return this.equalKeys(other) && ((LedgerActionTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[LedgerActionTypes |");
