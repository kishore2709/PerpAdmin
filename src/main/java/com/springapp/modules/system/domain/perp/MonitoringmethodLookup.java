...
@Entity(name="monitoringmethod_lookup")
public class MonitoringmethodLookup implements Serializable {
    ...
    @JoinColumn(name="MonitoringMethod_UID", nullable=false)
    ...
    /**
     * Compares the key for this instance with another MonitoringmethodLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class MonitoringmethodLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof MonitoringmethodLookup)) {
            return false;
        }
        MonitoringmethodLookup that = (MonitoringmethodLookup) other;
    ...
    /**
     * Compares this instance with another MonitoringmethodLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof MonitoringmethodLookup)) return false;
        return this.equalKeys(other) && ((MonitoringmethodLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[MonitoringmethodLookup |");
