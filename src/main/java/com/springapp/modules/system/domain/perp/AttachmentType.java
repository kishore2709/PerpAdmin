...
public class AttachmentType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another AttachmentType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class AttachmentType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        AttachmentType that = (AttachmentType) other;
    ...
    /**
     * Compares this instance with another AttachmentType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof AttachmentType)) return false;
        return this.equalKeys(other) && ((AttachmentType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[AttachmentType |");
