...
public class InspectionType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another InspectionType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class InspectionType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof InspectionType)) {
            return false;
        }
        InspectionType that = (InspectionType) other;
    ...
    /**
     * Compares this instance with another InspectionType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof InspectionType)) return false;
        return this.equalKeys(other) && ((InspectionType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[InspectionType |");
