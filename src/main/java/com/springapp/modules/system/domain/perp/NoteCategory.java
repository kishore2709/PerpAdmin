...
public class NoteCategory implements Serializable {
    ...
    /**
     * Compares the key for this instance with another NoteCategory.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class NoteCategory and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof NoteCategory)) {
            return false;
        }
        NoteCategory that = (NoteCategory) other;
    ...
    /**
     * Compares this instance with another NoteCategory.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof NoteCategory)) return false;
        return this.equalKeys(other) && ((NoteCategory)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[NoteCategory |");
