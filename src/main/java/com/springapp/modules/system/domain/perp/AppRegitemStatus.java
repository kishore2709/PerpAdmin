...
@Entity(name="app_regitem_status")
public class AppRegitemStatus implements Serializable {
    ...
    @OneToMany(mappedBy="appRegitemStatus")
    private Set<ApptransRegRel> apptransRegRel;

    /** Default constructor. */
    public AppRegitemStatus() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another AppRegitemStatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class AppRegitemStatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof AppRegitemStatus)) {
            return false;
        }
        AppRegitemStatus that = (AppRegitemStatus) other;
    ...
    /**
     * Compares this instance with another AppRegitemStatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof AppRegitemStatus)) return false;
        return this.equalKeys(other) && ((AppRegitemStatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[AppRegitemStatus |");
