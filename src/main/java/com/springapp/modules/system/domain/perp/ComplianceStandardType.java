...
@Entity(name="compliance_standard_type")
public class ComplianceStandardType implements Serializable {
    ...
    @OneToMany(mappedBy="complianceStandardType")
    private Set<ComplianceInformation> complianceInformation;

    /** Default constructor. */
    public ComplianceStandardType() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another ComplianceStandardType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ComplianceStandardType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ComplianceStandardType)) {
            return false;
        }
        ComplianceStandardType that = (ComplianceStandardType) other;
    ...
    /**
     * Compares this instance with another ComplianceStandardType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ComplianceStandardType)) return false;
        return this.equalKeys(other) && ((ComplianceStandardType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ComplianceStandardType |");
