...
@Entity(name="apce_filter_types")
public class ApceFilterTypes implements Serializable {
    ...
    @OneToMany(mappedBy="apceFilterTypes")
    private Set<RegitemDetails> regitemDetails;

    /** Default constructor. */
    public ApceFilterTypes() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another ApceFilterTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ApceFilterTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ApceFilterTypes)) {
            return false;
        }
        ApceFilterTypes that = (ApceFilterTypes) other;
    ...
    /**
     * Compares this instance with another ApceFilterTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ApceFilterTypes)) return false;
        return this.equalKeys(other) && ((ApceFilterTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ApceFilterTypes |");
