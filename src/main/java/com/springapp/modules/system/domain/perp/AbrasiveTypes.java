...
@Entity(name="abrasive_types")
public class AbrasiveTypes implements Serializable {
    ...
    @OneToMany(mappedBy="abrasiveTypes")
    private Set<AbrasiveRelations> abrasiveRelations;

    /** Default constructor. */
    public AbrasiveTypes() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another AbrasiveTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class AbrasiveTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof AbrasiveTypes)) {
            return false;
        }
        AbrasiveTypes that = (AbrasiveTypes) other;
    ...
    /**
     * Compares this instance with another AbrasiveTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof AbrasiveTypes)) return false;
        return this.equalKeys(other) && ((AbrasiveTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[AbrasiveTypes |");
