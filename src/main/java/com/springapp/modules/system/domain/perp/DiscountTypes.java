...
public class DiscountTypes implements Serializable {
    ...
    @OneToMany(mappedBy="discountTypes")
    ...
    /**
     * Compares the key for this instance with another DiscountTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class DiscountTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof DiscountTypes)) {
            return false;
        }
        DiscountTypes that = (DiscountTypes) other;
    ...
    /**
     * Compares this instance with another DiscountTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof DiscountTypes)) return false;
        return this.equalKeys(other) && ((DiscountTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[DiscountTypes |");
