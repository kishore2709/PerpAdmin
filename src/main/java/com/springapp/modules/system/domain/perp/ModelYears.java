...
public class ModelYears implements Serializable {
    ...
    /**
     * Compares the key for this instance with another ModelYears.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ModelYears and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ModelYears)) {
            return false;
        }
        ModelYears that = (ModelYears) other;
    ...
    /**
     * Compares this instance with another ModelYears.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ModelYears)) return false;
        return this.equalKeys(other) && ((ModelYears)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ModelYears |");
