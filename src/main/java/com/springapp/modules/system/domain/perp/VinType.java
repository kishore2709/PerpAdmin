...
@Entity(name="vin_type")
public class VinType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another VinType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class VinType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof VinType)) {
            return false;
        }
        VinType that = (VinType) other;
    ...
    /**
     * Compares this instance with another VinType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof VinType)) return false;
        return this.equalKeys(other) && ((VinType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[VinType |");
