...
@Entity(name="uom_voc_lookup")
public class UomVocLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomVocLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomVocLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomVocLookup)) {
            return false;
        }
        UomVocLookup that = (UomVocLookup) other;
    ...
    /**
     * Compares this instance with another UomVocLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomVocLookup)) return false;
        return this.equalKeys(other) && ((UomVocLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomVocLookup |");
