...
public class AddressType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another AddressType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class AddressType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        AddressType that = (AddressType) other;
    ...
    /**
     * Compares this instance with another AddressType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        ...
        return this.equalKeys(other) && ((AddressType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[AddressType |");
