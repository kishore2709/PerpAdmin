...
public class ApplicationStatus implements Serializable {
    ...
    /**
     * Compares the key for this instance with another ApplicationStatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ApplicationStatus and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another ApplicationStatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        ...
        return this.equalKeys(other) && ((ApplicationStatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ApplicationStatus |");
