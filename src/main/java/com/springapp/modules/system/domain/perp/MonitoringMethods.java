...
@Entity(name="monitoring_methods")
public class MonitoringMethods implements Serializable {
    ...
    @OneToMany(mappedBy="monitoringMethods")
    ...
    /**
     * Compares the key for this instance with another MonitoringMethods.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class MonitoringMethods and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof MonitoringMethods)) {
            return false;
        }
        MonitoringMethods that = (MonitoringMethods) other;
    ...
    /**
     * Compares this instance with another MonitoringMethods.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof MonitoringMethods)) return false;
        return this.equalKeys(other) && ((MonitoringMethods)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[MonitoringMethods |");
