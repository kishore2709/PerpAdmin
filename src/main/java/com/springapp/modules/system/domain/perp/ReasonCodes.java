...
public class ReasonCodes implements Serializable {
    ...
    @OneToMany(mappedBy="reasonCodes")
    ...
    /**
     * Compares the key for this instance with another ReasonCodes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ReasonCodes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ReasonCodes)) {
            return false;
        }
        ReasonCodes that = (ReasonCodes) other;
    ...
    /**
     * Compares this instance with another ReasonCodes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ReasonCodes)) return false;
        return this.equalKeys(other) && ((ReasonCodes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ReasonCodes |");
