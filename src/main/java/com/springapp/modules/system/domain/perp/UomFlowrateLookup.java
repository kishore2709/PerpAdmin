...
@Entity(name="uom_flowrate_lookup")
public class UomFlowrateLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomFlowrateLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomFlowrateLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomFlowrateLookup)) {
            return false;
        }
        UomFlowrateLookup that = (UomFlowrateLookup) other;
    ...
    /**
     * Compares this instance with another UomFlowrateLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomFlowrateLookup)) return false;
        return this.equalKeys(other) && ((UomFlowrateLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomFlowrateLookup |");
