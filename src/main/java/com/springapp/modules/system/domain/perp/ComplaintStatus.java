...
public class ComplaintStatus implements Serializable {
    ...
    /**
     * Compares the key for this instance with another ComplaintStatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ComplaintStatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ComplaintStatus)) {
            return false;
        }
        ComplaintStatus that = (ComplaintStatus) other;
    ...
    /**
     * Compares this instance with another ComplaintStatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ComplaintStatus)) return false;
        return this.equalKeys(other) && ((ComplaintStatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ComplaintStatus |");
