...
@Entity(name="engine_hp_type")
public class EngineHpType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another EngineHpType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class EngineHpType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof EngineHpType)) {
            return false;
        }
        EngineHpType that = (EngineHpType) other;
    ...
    /**
     * Compares this instance with another EngineHpType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EngineHpType)) return false;
        return this.equalKeys(other) && ((EngineHpType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[EngineHpType |");
