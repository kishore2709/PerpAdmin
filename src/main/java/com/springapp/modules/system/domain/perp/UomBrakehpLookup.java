...
@Entity(name="uom_brakehp_lookup")
public class UomBrakehpLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomBrakehpLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomBrakehpLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomBrakehpLookup)) {
            return false;
        }
        UomBrakehpLookup that = (UomBrakehpLookup) other;
    ...
    /**
     * Compares this instance with another UomBrakehpLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomBrakehpLookup)) return false;
        return this.equalKeys(other) && ((UomBrakehpLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomBrakehpLookup |");
