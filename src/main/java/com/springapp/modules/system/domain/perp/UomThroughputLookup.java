...
@Entity(name="uom_throughput_lookup")
public class UomThroughputLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomThroughputLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomThroughputLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomThroughputLookup)) {
            return false;
        }
        UomThroughputLookup that = (UomThroughputLookup) other;
    ...
    /**
     * Compares this instance with another UomThroughputLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomThroughputLookup)) return false;
        return this.equalKeys(other) && ((UomThroughputLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomThroughputLookup |");
