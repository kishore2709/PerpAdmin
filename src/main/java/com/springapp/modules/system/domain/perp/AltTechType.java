...
@Entity(name="alt_tech_type")
public class AltTechType implements Serializable {
    ...
    @OneToMany(mappedBy="altTechType")
    ...
    /**
     * Compares the key for this instance with another AltTechType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class AltTechType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof AltTechType)) {
            return false;
        }
        AltTechType that = (AltTechType) other;
    ...
    /**
     * Compares this instance with another AltTechType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof AltTechType)) return false;
        return this.equalKeys(other) && ((AltTechType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[AltTechType |");
