...
public class Tiers implements Serializable {
    ...
    /**
     * Compares the key for this instance with another Tiers.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Tiers and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another Tiers.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof Tiers)) return false;
        return this.equalKeys(other) && ((Tiers)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[Tiers |");
