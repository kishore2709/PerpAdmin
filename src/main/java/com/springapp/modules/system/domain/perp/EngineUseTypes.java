...
@Entity(name="engine_use_types")
public class EngineUseTypes implements Serializable {
    ...
    @OneToMany(mappedBy="engineUseTypes")
    private Set<RegitemDetails> regitemDetails;

    /** Default constructor. */
    public EngineUseTypes() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another EngineUseTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class EngineUseTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof EngineUseTypes)) {
            return false;
        }
        EngineUseTypes that = (EngineUseTypes) other;
    ...
    /**
     * Compares this instance with another EngineUseTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EngineUseTypes)) return false;
        return this.equalKeys(other) && ((EngineUseTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[EngineUseTypes |");
