...
public class PhoneType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another PhoneType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class PhoneType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        PhoneType that = (PhoneType) other;
    ...
    /**
     * Compares this instance with another PhoneType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        ...
        return this.equalKeys(other) && ((PhoneType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[PhoneType |");
