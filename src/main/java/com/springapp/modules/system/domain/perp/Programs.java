...
public class Programs implements Serializable {
    ...
    /**
     * Compares the key for this instance with another Programs.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Programs and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another Programs.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof Programs)) return false;
        return this.equalKeys(other) && ((Programs)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[Programs |");
