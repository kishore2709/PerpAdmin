...
@Entity(name="template_text_areas")
public class TemplateTextAreas implements Serializable {
    ...
    @OneToMany(mappedBy="templateTextAreas")
    private Set<DocTemplateTexts> docTemplateTexts;

    /** Default constructor. */
    public TemplateTextAreas() {
        super();
    }
     ...
     */
    public Set<DocTemplateTexts> getDocTemplateTexts() {
     ...
     */
    public void setDocTemplateTexts(Set<DocTemplateTexts> aDocTemplateTexts) {
        docTemplateTexts = aDocTemplateTexts;
    }

    /**
     * Compares the key for this instance with another TemplateTextAreas.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class TemplateTextAreas and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof TemplateTextAreas)) {
            return false;
        }
        TemplateTextAreas that = (TemplateTextAreas) other;
    ...
    /**
     * Compares this instance with another TemplateTextAreas.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof TemplateTextAreas)) return false;
        return this.equalKeys(other) && ((TemplateTextAreas)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[TemplateTextAreas |");
