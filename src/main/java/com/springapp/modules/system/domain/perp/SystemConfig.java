...
public class SystemConfig implements Serializable {
    ...
    private Set<SysconfigAttr> sysconfigAttr;
    ...
    /**
     * Access method for sysconfigAttr.
     *
     * @return the current value of sysconfigAttr
     */
    public Set<SysconfigAttr> getSysconfigAttr() {
        return sysconfigAttr;
    }

    /**
     * Setter method for sysconfigAttr.
     *
     * @param aSysconfigAttr the new value for sysconfigAttr
     */
    public void setSysconfigAttr(Set<SysconfigAttr> aSysconfigAttr) {
        sysconfigAttr = aSysconfigAttr;
    }

    /**
     * Compares the key for this instance with another SystemConfig.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class SystemConfig and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        SystemConfig that = (SystemConfig) other;
    ...
    /**
     * Compares this instance with another SystemConfig.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof SystemConfig)) return false;
        return this.equalKeys(other) && ((SystemConfig)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[SystemConfig |");
