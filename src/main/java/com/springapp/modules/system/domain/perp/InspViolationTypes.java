...
@Entity(name="insp_violation_types")
public class InspViolationTypes implements Serializable {
    ...
    @OneToMany(mappedBy="inspViolationTypes")
    private Set<InspViolations> inspViolations;

    /** Default constructor. */
    public InspViolationTypes() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another InspViolationTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class InspViolationTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof InspViolationTypes)) {
            return false;
        }
        InspViolationTypes that = (InspViolationTypes) other;
    ...
    /**
     * Compares this instance with another InspViolationTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof InspViolationTypes)) return false;
        return this.equalKeys(other) && ((InspViolationTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[InspViolationTypes |");
