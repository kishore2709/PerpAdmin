...
public class ContactType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another ContactType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ContactType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        ContactType that = (ContactType) other;
    ...
    /**
     * Compares this instance with another ContactType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ContactType)) return false;
        return this.equalKeys(other) && ((ContactType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ContactType |");
