...
public class TerminalType implements Serializable {
    ...
    @OneToMany(mappedBy="terminalType")
    ...
    /**
     * Compares the key for this instance with another TerminalType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class TerminalType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        TerminalType that = (TerminalType) other;
    ...
    /**
     * Compares this instance with another TerminalType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof TerminalType)) return false;
        return this.equalKeys(other) && ((TerminalType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[TerminalType |");
