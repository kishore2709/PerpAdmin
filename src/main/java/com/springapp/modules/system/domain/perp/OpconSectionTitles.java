...
@Entity(name="opcon_section_titles")
public class OpconSectionTitles implements Serializable {
    ...
    @OneToMany(mappedBy="opconSectionTitles")
    private Set<RegtypesSectitlesRel> regtypesSectitlesRel;

    /** Default constructor. */
    public OpconSectionTitles() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another OpconSectionTitles.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class OpconSectionTitles and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof OpconSectionTitles)) {
            return false;
        }
        OpconSectionTitles that = (OpconSectionTitles) other;
    ...
    /**
     * Compares this instance with another OpconSectionTitles.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof OpconSectionTitles)) return false;
        return this.equalKeys(other) && ((OpconSectionTitles)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[OpconSectionTitles |");
