...
@Entity(name="uom_fuelconsumption_lookup")
public class UomFuelconsumptionLookup implements Serializable {
    ...
    /** Default constructor. */
    public UomFuelconsumptionLookup() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UomFuelconsumptionLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomFuelconsumptionLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomFuelconsumptionLookup)) {
            return false;
        }
        UomFuelconsumptionLookup that = (UomFuelconsumptionLookup) other;
    ...
    /**
     * Compares this instance with another UomFuelconsumptionLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomFuelconsumptionLookup)) return false;
        return this.equalKeys(other) && ((UomFuelconsumptionLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomFuelconsumptionLookup |");
