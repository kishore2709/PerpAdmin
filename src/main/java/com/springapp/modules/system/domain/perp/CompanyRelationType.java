...
@Entity(name="company_relation_type")
public class CompanyRelationType implements Serializable {
    ...
    @OneToMany(mappedBy="companyRelationType")
    ...
    /**
     * Compares the key for this instance with another CompanyRelationType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class CompanyRelationType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof CompanyRelationType)) {
            return false;
        }
        CompanyRelationType that = (CompanyRelationType) other;
    ...
    /**
     * Compares this instance with another CompanyRelationType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof CompanyRelationType)) return false;
        return this.equalKeys(other) && ((CompanyRelationType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[CompanyRelationType |");
