...
@Entity(name="sand_types")
public class SandTypes implements Serializable {
    ...
    /**
     * Compares the key for this instance with another SandTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class SandTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof SandTypes)) {
            return false;
        }
        SandTypes that = (SandTypes) other;
    ...
    /**
     * Compares this instance with another SandTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof SandTypes)) return false;
        return this.equalKeys(other) && ((SandTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[SandTypes |");
