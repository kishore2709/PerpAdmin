...
@Entity(name="salutation_type")
public class SalutationType implements Serializable {
    ...
    @OneToMany(mappedBy="salutationType")
    ...
    /**
     * Compares the key for this instance with another SalutationType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class SalutationType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof SalutationType)) {
            return false;
        }
        SalutationType that = (SalutationType) other;
    ...
    /**
     * Compares this instance with another SalutationType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof SalutationType)) return false;
        return this.equalKeys(other) && ((SalutationType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[SalutationType |");
