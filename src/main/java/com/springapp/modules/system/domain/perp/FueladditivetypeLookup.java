...
@Entity(name="fueladditivetype_lookup")
public class FueladditivetypeLookup implements Serializable {
    ...
    @JoinColumn(name="FuelAdditiveType_UID", nullable=false)
    ...
    /**
     * Compares the key for this instance with another FueladditivetypeLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class FueladditivetypeLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof FueladditivetypeLookup)) {
            return false;
        }
        FueladditivetypeLookup that = (FueladditivetypeLookup) other;
    ...
    /**
     * Compares this instance with another FueladditivetypeLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof FueladditivetypeLookup)) return false;
        return this.equalKeys(other) && ((FueladditivetypeLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[FueladditivetypeLookup |");
