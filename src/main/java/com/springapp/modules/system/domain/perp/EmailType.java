...
public class EmailType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another EmailType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class EmailType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        EmailType that = (EmailType) other;
    ...
    /**
     * Compares this instance with another EmailType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EmailType)) return false;
        return this.equalKeys(other) && ((EmailType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[EmailType |");
