...
public class PaymentMethods implements Serializable {
    ...
    private Set<AccountingBatch> accountingBatch;
    @OneToMany(mappedBy="paymentMethods")
     ...
     */
    public Set<AccountingBatch> getAccountingBatch() {
     ...
     */
    public void setAccountingBatch(Set<AccountingBatch> aAccountingBatch) {
    ...
    /**
     * Compares the key for this instance with another PaymentMethods.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class PaymentMethods and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        PaymentMethods that = (PaymentMethods) other;
    ...
    /**
     * Compares this instance with another PaymentMethods.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof PaymentMethods)) return false;
        return this.equalKeys(other) && ((PaymentMethods)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[PaymentMethods |");
