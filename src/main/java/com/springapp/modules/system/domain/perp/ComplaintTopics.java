...
@Entity(name="complaint_topics")
public class ComplaintTopics implements Serializable {
    ...
    @OneToMany(mappedBy="complaintTopics")
    ...
    /**
     * Compares the key for this instance with another ComplaintTopics.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ComplaintTopics and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ComplaintTopics)) {
            return false;
        }
        ComplaintTopics that = (ComplaintTopics) other;
    ...
    /**
     * Compares this instance with another ComplaintTopics.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ComplaintTopics)) return false;
        return this.equalKeys(other) && ((ComplaintTopics)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ComplaintTopics |");
