...
@Entity(name="blasting_type")
public class BlastingType implements Serializable {
    ...
    @OneToMany(mappedBy="blastingType")
    ...
    /**
     * Compares the key for this instance with another BlastingType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class BlastingType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof BlastingType)) {
            return false;
        }
        BlastingType that = (BlastingType) other;
    ...
    /**
     * Compares this instance with another BlastingType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof BlastingType)) return false;
        return this.equalKeys(other) && ((BlastingType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[BlastingType |");
