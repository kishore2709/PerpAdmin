...
public class ManufacturerTypeAud implements Serializable {
    ...
    private int manufacturerTypeAudUid;
     ...
     */
    public int getManufacturerTypeAudUid() {
     ...
     */
    public void setManufacturerTypeAudUid(int aManufacturerTypeAudUid) {
    ...
    private boolean equalKeys(Object other) {
        ...
        if (this.getManufacturerTypeAudUid() != that.getManufacturerTypeAudUid()) {
            return false;
        }
        return true;
    }
    ...
    public Map<String, Object> getPrimaryKey() {
        ...
        ret.put("manufacturerTypeAudUid", Integer.valueOf(getManufacturerTypeAudUid()));
        return ret;
    }
