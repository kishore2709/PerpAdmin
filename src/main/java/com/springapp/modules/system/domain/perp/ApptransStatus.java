...
@Entity(name="apptrans_status")
public class ApptransStatus implements Serializable {
    ...
    @OneToMany(mappedBy="apptransStatus")
    private Set<AppTransactions> appTransactions;

    /** Default constructor. */
    public ApptransStatus() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another ApptransStatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ApptransStatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ApptransStatus)) {
            return false;
        }
        ApptransStatus that = (ApptransStatus) other;
    ...
    /**
     * Compares this instance with another ApptransStatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ApptransStatus)) return false;
        return this.equalKeys(other) && ((ApptransStatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ApptransStatus |");
