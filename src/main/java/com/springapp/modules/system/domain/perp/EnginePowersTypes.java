...
@Entity(name="engine_powers_types")
public class EnginePowersTypes implements Serializable {
    ...
    @OneToMany(mappedBy="enginePowersTypes")
    private Set<RegitemDetails> regitemDetails;

    /** Default constructor. */
    public EnginePowersTypes() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another EnginePowersTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class EnginePowersTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof EnginePowersTypes)) {
            return false;
        }
        EnginePowersTypes that = (EnginePowersTypes) other;
    ...
    /**
     * Compares this instance with another EnginePowersTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EnginePowersTypes)) return false;
        return this.equalKeys(other) && ((EnginePowersTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[EnginePowersTypes |");
