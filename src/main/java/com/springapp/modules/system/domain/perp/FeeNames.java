...
@Entity(name="fee_names")
public class FeeNames implements Serializable {
    ...
    /**
     * Compares the key for this instance with another FeeNames.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class FeeNames and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof FeeNames)) {
            return false;
        }
        FeeNames that = (FeeNames) other;
    ...
    /**
     * Compares this instance with another FeeNames.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof FeeNames)) return false;
        return this.equalKeys(other) && ((FeeNames)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[FeeNames |");
