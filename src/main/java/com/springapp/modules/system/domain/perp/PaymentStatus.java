...
public class PaymentStatus implements Serializable {
    ...
    /**
     * Compares the key for this instance with another PaymentStatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class PaymentStatus and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another PaymentStatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        ...
        return this.equalKeys(other) && ((PaymentStatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[PaymentStatus |");
