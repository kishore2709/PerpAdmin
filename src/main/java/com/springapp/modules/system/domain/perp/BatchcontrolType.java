...
@Entity(name="batchcontrol_type")
public class BatchcontrolType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another BatchcontrolType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class BatchcontrolType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof BatchcontrolType)) {
            return false;
        }
        BatchcontrolType that = (BatchcontrolType) other;
    ...
    /**
     * Compares this instance with another BatchcontrolType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof BatchcontrolType)) return false;
        return this.equalKeys(other) && ((BatchcontrolType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[BatchcontrolType |");
