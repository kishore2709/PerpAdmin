...
@Entity(name="additional_equip_info_type")
public class AdditionalEquipInfoType implements Serializable {
    ...
    @OneToMany(mappedBy="additionalEquipInfoType")
    private Set<RegitemDetails> regitemDetails;

    /** Default constructor. */
    public AdditionalEquipInfoType() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another AdditionalEquipInfoType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class AdditionalEquipInfoType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof AdditionalEquipInfoType)) {
            return false;
        }
        AdditionalEquipInfoType that = (AdditionalEquipInfoType) other;
    ...
    /**
     * Compares this instance with another AdditionalEquipInfoType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof AdditionalEquipInfoType)) return false;
        return this.equalKeys(other) && ((AdditionalEquipInfoType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[AdditionalEquipInfoType |");
