...
@Entity(name="regitem_types")
public class RegitemTypes implements Serializable {
    ...
    @OneToMany(mappedBy="regitemTypes")
    private Set<PerpFeeTypeRel> perpFeeTypeRel;
    @OneToMany(mappedBy="regitemTypes")
    private Set<RegistrationItems> registrationItems;
    @OneToMany(mappedBy="regitemTypes")
    private Set<RegitemSubtypes> regitemSubtypes;
    @OneToMany(mappedBy="regitemTypes")
    private Set<RegtypesSectitlesRel> regtypesSectitlesRel;
     ...
     */
    public Set<RegitemSubtypes> getRegitemSubtypes() {
     ...
     */
    public void setRegitemSubtypes(Set<RegitemSubtypes> aRegitemSubtypes) {
     ...
     */
    public Set<RegtypesSectitlesRel> getRegtypesSectitlesRel() {
     ...
     */
    public void setRegtypesSectitlesRel(Set<RegtypesSectitlesRel> aRegtypesSectitlesRel) {
        regtypesSectitlesRel = aRegtypesSectitlesRel;
    }

    /**
     * Compares the key for this instance with another RegitemTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class RegitemTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof RegitemTypes)) {
            return false;
        }
        RegitemTypes that = (RegitemTypes) other;
    ...
    /**
     * Compares this instance with another RegitemTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegitemTypes)) return false;
        return this.equalKeys(other) && ((RegitemTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[RegitemTypes |");
