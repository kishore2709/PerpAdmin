...
@Entity(name="uom_co_lookup")
public class UomCoLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomCoLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomCoLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomCoLookup)) {
            return false;
        }
        UomCoLookup that = (UomCoLookup) other;
    ...
    /**
     * Compares this instance with another UomCoLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomCoLookup)) return false;
        return this.equalKeys(other) && ((UomCoLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomCoLookup |");
