...
@Entity(name="perp_document_types")
public class PerpDocumentTypes implements Serializable {
    ...
    /**
     * Compares the key for this instance with another PerpDocumentTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class PerpDocumentTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof PerpDocumentTypes)) {
            return false;
        }
        PerpDocumentTypes that = (PerpDocumentTypes) other;
    ...
    /**
     * Compares this instance with another PerpDocumentTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof PerpDocumentTypes)) return false;
        return this.equalKeys(other) && ((PerpDocumentTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[PerpDocumentTypes |");
