...
@Entity(name="note_search_type")
public class NoteSearchType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another NoteSearchType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class NoteSearchType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof NoteSearchType)) {
            return false;
        }
        NoteSearchType that = (NoteSearchType) other;
    ...
    /**
     * Compares this instance with another NoteSearchType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof NoteSearchType)) return false;
        return this.equalKeys(other) && ((NoteSearchType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[NoteSearchType |");
