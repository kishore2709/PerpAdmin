...
@Entity(name="uom_powerrating_lookup")
public class UomPowerratingLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomPowerratingLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomPowerratingLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomPowerratingLookup)) {
            return false;
        }
        UomPowerratingLookup that = (UomPowerratingLookup) other;
    ...
    /**
     * Compares this instance with another UomPowerratingLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomPowerratingLookup)) return false;
        return this.equalKeys(other) && ((UomPowerratingLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomPowerratingLookup |");
