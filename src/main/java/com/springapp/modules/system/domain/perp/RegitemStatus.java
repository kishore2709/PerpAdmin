...
public class RegitemStatus implements Serializable {
    ...
    @OneToMany(mappedBy="regitemStatus")
    private Set<RegistrationItems> registrationItems;

    /** Default constructor. */
    public RegitemStatus() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another RegitemStatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class RegitemStatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof RegitemStatus)) {
            return false;
        }
    ...
    /**
     * Compares this instance with another RegitemStatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegitemStatus)) return false;
        return this.equalKeys(other) && ((RegitemStatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[RegitemStatus |");
