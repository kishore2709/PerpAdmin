...
public class ActionrequestDecisionRel implements Serializable {
    ...
    private boolean equalKeys(Object other) {
        ...
        Object myRequestDecisionRelUid = this.getRequestDecisionRelUid();
        Object yourRequestDecisionRelUid = that.getRequestDecisionRelUid();
        if (myRequestDecisionRelUid==null ? yourRequestDecisionRelUid!=null : !myRequestDecisionRelUid.equals(yourRequestDecisionRelUid)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        int i;
        int result = 17;
        if (getRequestDecisionRelUid() == null) {
            i = 0;
        } else {
            i = getRequestDecisionRelUid().hashCode();
        }
        result = 37*result + i;
        return result;
    }
    ...
    public Map<String, Object> getPrimaryKey() {
        ...
        ret.put("requestDecisionRelUid", getRequestDecisionRelUid());
        return ret;
    }
