...
@Entity(name="uom_sox_lookup")
public class UomSoxLookup implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UomSoxLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UomSoxLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UomSoxLookup)) {
            return false;
        }
        UomSoxLookup that = (UomSoxLookup) other;
    ...
    /**
     * Compares this instance with another UomSoxLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UomSoxLookup)) return false;
        return this.equalKeys(other) && ((UomSoxLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UomSoxLookup |");
