...
@Entity(name="apptrans_types")
public class ApptransTypes implements Serializable {
    ...
    @OneToMany(mappedBy="apptransTypes")
    private Set<AppTransactions> appTransactions;

    /** Default constructor. */
    public ApptransTypes() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another ApptransTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ApptransTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ApptransTypes)) {
            return false;
        }
        ApptransTypes that = (ApptransTypes) other;
    ...
    /**
     * Compares this instance with another ApptransTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ApptransTypes)) return false;
        return this.equalKeys(other) && ((ApptransTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ApptransTypes |");
