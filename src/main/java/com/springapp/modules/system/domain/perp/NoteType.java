...
public class NoteType implements Serializable {
    ...
    /**
     * Compares the key for this instance with another NoteType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class NoteType and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another NoteType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof NoteType)) return false;
        return this.equalKeys(other) && ((NoteType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[NoteType |");
