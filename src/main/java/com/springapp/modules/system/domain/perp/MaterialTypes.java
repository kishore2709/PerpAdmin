...
public class MaterialTypes implements Serializable {
    ...
    @OneToMany(mappedBy="materialTypes")
    ...
    /**
     * Compares the key for this instance with another MaterialTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class MaterialTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof MaterialTypes)) {
            return false;
        }
        MaterialTypes that = (MaterialTypes) other;
    ...
    /**
     * Compares this instance with another MaterialTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof MaterialTypes)) return false;
        return this.equalKeys(other) && ((MaterialTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[MaterialTypes |");
