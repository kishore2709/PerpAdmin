...
@Entity(name="regitemcomponent_types")
public class RegitemcomponentTypes implements Serializable {
    ...
    /**
     * Compares the key for this instance with another RegitemcomponentTypes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class RegitemcomponentTypes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof RegitemcomponentTypes)) {
            return false;
        }
        RegitemcomponentTypes that = (RegitemcomponentTypes) other;
    ...
    /**
     * Compares this instance with another RegitemcomponentTypes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegitemcomponentTypes)) return false;
        return this.equalKeys(other) && ((RegitemcomponentTypes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[RegitemcomponentTypes |");
