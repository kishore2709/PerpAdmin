...
@Entity(name="emissioncontroltype_lookup")
public class EmissioncontroltypeLookup implements Serializable {
    ...
    /** Default constructor. */
    public EmissioncontroltypeLookup() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another EmissioncontroltypeLookup.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class EmissioncontroltypeLookup and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof EmissioncontroltypeLookup)) {
            return false;
        }
        EmissioncontroltypeLookup that = (EmissioncontroltypeLookup) other;
    ...
    /**
     * Compares this instance with another EmissioncontroltypeLookup.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EmissioncontroltypeLookup)) return false;
        return this.equalKeys(other) && ((EmissioncontroltypeLookup)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[EmissioncontroltypeLookup |");
