...
@Entity(name="expiration_date_type")
public class ExpirationDateType implements Serializable {
    ...
    @OneToMany(mappedBy="expirationDateType")
    ...
    /**
     * Compares the key for this instance with another ExpirationDateType.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class ExpirationDateType and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof ExpirationDateType)) {
            return false;
        }
        ExpirationDateType that = (ExpirationDateType) other;
    ...
    /**
     * Compares this instance with another ExpirationDateType.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ExpirationDateType)) return false;
        return this.equalKeys(other) && ((ExpirationDateType)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[ExpirationDateType |");
